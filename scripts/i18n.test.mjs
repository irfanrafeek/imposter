...
const EXPECTED_SLOTS = {
  ...
  'chat.unread': ['count'],
  'card.starting-in': ['n'],
  'clock.closes-in': ['time'],
  'clock.restarts-in': ['time'],
  'clock.starts-in': ['time'],
  'clock.vote-ends-in': ['time'],
  'clock.waiting-in': ['time'],
  ...
  'lobby.online-closes-if-few': ['count'],
