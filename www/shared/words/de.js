...
export const WORD_CATEGORIES = {
  'Food': [
    ...
    { w: 'Matjes', h: 'Gepökelt', h2: 'Mild', h3: 'Fischbude' },
    { w: 'Lachs', h: 'Räuchern', h2: 'Rosa', h3: 'Feiertag' },
    { w: 'Krabben', h: 'Winzig', h2: 'Schälen', h3: 'Nordsee' },
    ...
    { w: 'Spätzle', h: 'Geschabt', h2: 'Teigig', h3: 'Gasthaus' },
    ...
    { w: 'Himbeere', h: 'Samtig', h2: 'Empfindlich', h3: 'Strauch' },
    { w: 'Traube', h: 'Kernlos', h2: 'Saftig', h3: 'Weinberg' },
  ...
  'Animals': [
    { w: 'Hund', h: 'Treu', h2: 'Bellen', h3: 'Haustier' },
    { w: 'Katze', h: 'Schnurren', h2: 'Geschmeidig', h3: 'Haustier' },
    { w: 'Kuh', h: 'Wiederkäuen', h2: 'Gefleckt', h3: 'Weide' },
    { w: 'Schwein', h: 'Rosig', h2: 'Suhlen', h3: 'Stall' },
    { w: 'Schaf', h: 'Wollig', h2: 'Blöken', h3: 'Weide' },
    { w: 'Ziege', h: 'Meckern', h2: 'Kletternd', h3: 'Bergpfad' },
    { w: 'Pferd', h: 'Wiehern', h2: 'Galopp', h3: 'Weide' },
    { w: 'Esel', h: 'Störrisch', h2: 'Langohrig', h3: 'Bergpfad' },
    { w: 'Huhn', h: 'Scharren', h2: 'Gackern', h3: 'Landleben' },
    { w: 'Hahn', h: 'Krähen', h2: 'Prahlerisch', h3: 'Stall' },
    { w: 'Truthahn', h: 'Kollern', h2: 'Plump', h3: 'Landleben' },
    ...
    { w: 'Hamster', h: 'Backentaschen', h2: 'Laufrad', h3: 'Haustier' },
    { w: 'Meerschweinchen', h: 'Quieken', h2: 'Rundlich', h3: 'Haustier' },
    { w: 'Igel', h: 'Stachelig', h2: 'Einrollen', h3: 'Laubhaufen' },
    { w: 'Maulwurf', h: 'Blind', h2: 'Erdhügel', h3: 'Blumenerde' },
    { w: 'Fuchs', h: 'Schlau', h2: 'Rötlich', h3: 'Waldrand' },
    { w: 'Wolf', h: 'Rudel', h2: 'Heulen', h3: 'Wildnis' },
    { w: 'Bär', h: 'Zottig', h2: 'Brummen', h3: 'Wildnis' },
    { w: 'Hirsch', h: 'Geweih', h2: 'Röhren', h3: 'Waldrand' },
    { w: 'Reh', h: 'Scheu', h2: 'Zierlich', h3: 'Waldrand' },
    { w: 'Wildschwein', h: 'Borstig', h2: 'Wühlen', h3: 'Waldrand' },
    { w: 'Dachs', h: 'Gestreift', h2: 'Nachtaktiv', h3: 'Laubhaufen' },
    { w: 'Eichhörnchen', h: 'Buschig', h2: 'Klettern', h3: 'Baumstamm' },
    { w: 'Fledermaus', h: 'Kopfüber', h2: 'Dämmerung', h3: 'Abendhimmel' },
    { w: 'Biber', h: 'Fällen', h2: 'Breitschwanz', h3: 'Flussufer' },
    { w: 'Otter', h: 'Glatt', h2: 'Tauchen', h3: 'Flussufer' },
    { w: 'Marder', h: 'Zerbeißen', h2: 'Geschmeidig', h3: 'Speicher' },
    { w: 'Wiesel', h: 'Schlank', h2: 'Blitzschnell', h3: 'Steinhaufen' },
    { w: 'Frosch', h: 'Quaken', h2: 'Hüpfen', h3: 'Teich' },
    { w: 'Kröte', h: 'Warzig', h2: 'Träge', h3: 'Teich' },
    { w: 'Molch', h: 'Glitschig', h2: 'Gemächlich', h3: 'Teich' },
    { w: 'Eidechse', h: 'Sonnen', h2: 'Huschen', h3: 'Steinhaufen' },
    ...
    { w: 'Spatz', h: 'Frech', h2: 'Tschilpen', h3: 'Vorgarten' },
    ...
    { w: 'Eule', h: 'Lautlos', h2: 'Wachsam', h3: 'Abendhimmel' },
    { w: 'Uhu', h: 'Riesig', h2: 'Rufen', h3: 'Felswand' },
    { w: 'Adler', h: 'Majestätisch', h2: 'Kreisen', h3: 'Gebirge' },
    { w: 'Falke', h: 'Sturzflug', h2: 'Scharfäugig', h3: 'Felswand' },
    { w: 'Storch', h: 'Klappern', h2: 'Langbeinig', h3: 'Hausdach' },
    { w: 'Schwan', h: 'Anmutig', h2: 'Zischen', h3: 'Schlossteich' },
    { w: 'Möwe', h: 'Kreischen', h2: 'Aufdringlich', h3: 'Hafenmauer' },
    { w: 'Reiher', h: 'Reglos', h2: 'Langhalsig', h3: 'Seeufer' },
    { w: 'Kranich', h: 'Ziehen', h2: 'Trompeten', h3: 'Herbsthimmel' },
    { w: 'Rabe', h: 'Krächzen', h2: 'Düster', h3: 'Feldweg' },
    { w: 'Elster', h: 'Diebisch', h2: 'Schwarzweiß', h3: 'Feldweg' },
    { w: 'Taube', h: 'Gurren', h2: 'Zutraulich', h3: 'Vorgarten' },
    { w: 'Kuckuck', h: 'Fremdnest', h2: 'Zweisilbig', h3: 'Frühlingswald' },
    { w: 'Schwalbe', h: 'Pfeilschnell', h2: 'Gabelschwanz', h3: 'Hausdach' },
    { w: 'Pinguin', h: 'Watscheln', h2: 'Gedrungen', h3: 'Eisscholle' },
    { w: 'Papagei', h: 'Nachplappern', h2: 'Farbenprächtig', h3: 'Haustier' },
    ...
    { w: 'Hecht', h: 'Lauernd', h2: 'Spitzmaulig', h3: 'Weiher' },
    { w: 'Aal', h: 'Schlängeln', h2: 'Dunkel', h3: 'Flussgrund' },
    { w: 'Wels', h: 'Bärtig', h2: 'Grundnah', h3: 'Flussgrund' },
    { w: 'Hai', h: 'Furchterregend', h2: 'Rückenflosse', h3: 'Ozean' },
    { w: 'Wal', h: 'Gewaltig', h2: 'Blasloch', h3: 'Ozean' },
    { w: 'Delfin', h: 'Verspielt', h2: 'Springend', h3: 'Ozean' },
    { w: 'Robbe', h: 'Speckig', h2: 'Behäbig', h3: 'Eisscholle' },
    { w: 'Qualle', h: 'Durchsichtig', h2: 'Nesselnd', h3: 'Brandung' },
    { w: 'Krebs', h: 'Zwicken', h2: 'Rückwärts', h3: 'Meeresgrund' },
    ...
    { w: 'Hummel', h: 'Pelzig', h2: 'Tieftönend', h3: 'Blütenfeld' },
    { w: 'Ameise', h: 'Emsig', h2: 'Stark', h3: 'Waldboden' },
    { w: 'Käfer', h: 'Gepanzert', h2: 'Krabbeln', h3: 'Baumstamm' },
    ...
    { w: 'Grille', h: 'Zirpen', h2: 'Verborgen', h3: 'Sommerabend' },
    { w: 'Heuschrecke', h: 'Springend', h2: 'Dürr', h3: 'Sommerwiese' },
    { w: 'Mücke', h: 'Surren', h2: 'Lästig', h3: 'Sommerabend' },
    { w: 'Fliege', h: 'Sirrend', h2: 'Unruhig', h3: 'Fensterbrett' },
    { w: 'Floh', h: 'Hochspringend', h2: 'Unsichtbar', h3: 'Fell' },
    { w: 'Laus', h: 'Kratzen', h2: 'Hartnäckig', h3: 'Fell' },
    { w: 'Löwe', h: 'Mähne', h2: 'Brüllen', h3: 'Savanne' },
    { w: 'Tiger', h: 'Streifen', h2: 'Anschleichen', h3: 'Urwald' },
    { w: 'Elefant', h: 'Rüssel', h2: 'Grau', h3: 'Steppe' },
    { w: 'Giraffe', h: 'Hochgewachsen', h2: 'Tupfen', h3: 'Steppe' },
    { w: 'Nashorn', h: 'Wuchtig', h2: 'Dickhäutig', h3: 'Steppe' },
  ...
  'Places': [
    ...
    { w: 'Bäckerei', h: 'Ofenwarm', h2: 'Theke', h3: 'Frühstückszeit' },
    ...
    { w: 'Kneipe', h: 'Tresen', h2: 'Gesellig', h3: 'Stammtischrunde' },
    ...
    { w: 'Gletscher', h: 'Eiskalt', h2: 'Blaugrün', h3: 'Bergtour' },
    ...
    { w: 'Leuchtturm', h: 'Blinkend', h2: 'Gestreift', h3: 'Küstenwanderung' },
    ...
    { w: 'Denkmal', h: 'Sockel', h2: 'Bronze', h3: 'Gedenktag' },
    ...
    { w: 'Wartezimmer', h: 'Zeitschriften', h2: 'Geduldig', h3: 'Grippewelle' },
  ],
  'Everyday Objects': [
    ...
    { w: 'Hose', h: 'Ausgebeult', h2: 'Lang', h3: 'Umkleidekabine' },
    ...
    { w: 'Koffer', h: 'Rollend', h2: 'Schwer', h3: 'Abflughalle' },
    ...
    { w: 'Heft', h: 'Liniert', h2: 'Dünn', h3: 'Schulranzen' },
  ...
  'Movies & TV': [
    { w: 'Titanic', h: 'Ozeanriese', h2: 'Geigen', h3: 'Kinospektakel' },
    { w: 'Avatar', h: 'Leuchtend', h2: 'Fremdplanet', h3: 'Kinospektakel' },
    { w: 'Matrix', h: 'Auswählen', h2: 'Zeitlupe', h3: 'Zukunftsthriller' },
    { w: 'Jurassic Park', h: 'Krallen', h2: 'Urzeitlich', h3: 'Kinospektakel' },
    { w: 'Star Wars', h: 'Lichtschwerter', h2: 'Galaxie', h3: 'Weltraumsaga' },
    { w: 'Harry Potter', h: 'Zauberei', h2: 'Internat', h3: 'Fantasyreihe' },
    { w: 'Der Herr der Ringe', h: 'Wanderung', h2: 'Freundschaft', h3: 'Fantasyreihe' },
    { w: 'Der König der Löwen', h: 'Verrat', h2: 'Herde', h3: 'Zeichentrickklassiker' },
    { w: 'Die Eiskönigin', h: 'Schwestern', h2: 'Frostig', h3: 'Mitsingfilm' },
    { w: 'Shrek', h: 'Sumpfig', h2: 'Grummelig', h3: 'Märchenwelt' },
    { w: 'Toy Story', h: 'Spielzeug', h2: 'Treuherzig', h3: 'Animationsfilm' },
    { w: 'Der Pate', h: 'Familienmacht', h2: 'Verschwiegen', h3: 'Gangsterfilm' },
    { w: 'Pulp Fiction', h: 'Dialoge', h2: 'Durcheinander', h3: 'Gangsterfilm' },
    { w: 'Forrest Gump', h: 'Laufen', h2: 'Zufälle', h3: 'Lebensgeschichte' },
    { w: 'Fluch der Karibik', h: 'Seeräuber', h2: 'Schwankend', h3: 'Abenteuerfilm' },
    { w: 'Findet Nemo', h: 'Suchend', h2: 'Weitläufig', h3: 'Animationsfilm' },
    { w: 'Minions', h: 'Kauderwelsch', h2: 'Knallgelb', h3: 'Animationskomödie' },
    { w: 'Der Grinch', h: 'Griesgrämig', h2: 'Miesepetrig', h3: 'Animationskomödie' },
    { w: 'Das Dschungelbuch', h: 'Tanzbär', h2: 'Sorglos', h3: 'Zeichentrickklassiker' },
    { w: 'Pippi Langstrumpf', h: 'Eigensinnig', h2: 'Sommersprossen', h3: 'Kinderbuchfigur' },
    { w: 'Heidi', h: 'Bergsommer', h2: 'Heimweh', h3: 'Kinderbuchfigur' },
    { w: 'Wickie', h: 'Listig', h2: 'Zeichentrick', h3: 'Kinderserie' },
    { w: 'Bibi Blocksberg', h: 'Hexerei', h2: 'Besenritt', h3: 'Hörspielreihe' },
    { w: 'Benjamin Blümchen', h: 'Rüsselrufe', h2: 'Gutmütig', h3: 'Hörspielreihe' },
    { w: 'Die Drei Fragezeichen', h: 'Detektive', h2: 'Rätselhaft', h3: 'Hörspielreihe' },
    { w: 'Löwenzahn', h: 'Naturwissen', h2: 'Erklärend', h3: 'Kinderprogramm' },
    { w: 'Die Sendung mit der Maus', h: 'Lehrreich', h2: 'Anschaulich', h3: 'Kinderprogramm' },
    { w: 'Sesamstraße', h: 'Puppenspiel', h2: 'Buchstaben', h3: 'Kinderprogramm' },
    { w: 'Das Boot', h: 'Beklemmend', h2: 'Tauchfahrt', h3: 'Kriegsfilm' },
    { w: 'Der Schuh des Manitu', h: 'Klamauk', h2: 'Westernparodie', h3: 'Filmkomödie' },
    { w: 'Good Bye Lenin', h: 'Wendezeit', h2: 'Vorgetäuscht', h3: 'Geteiltes Land' },
    { w: 'Das Leben der Anderen', h: 'Abhören', h2: 'Mitschnitt', h3: 'Geteiltes Land' },
    { w: 'Die Feuerzangenbowle', h: 'Schulstreiche', h2: 'Schwarzweiß', h3: 'Feiertagsabend' },
    { w: 'Lola rennt', h: 'Hetzend', h2: 'Rothaarig', h3: 'Kinohit' },
    { w: 'Der Untergang', h: 'Bunker', h2: 'Endzeit', h3: 'Kriegsfilm' },
    { w: 'Sissi', h: 'Kaiserhof', h2: 'Romantisch', h3: 'Feiertagsabend' },
    { w: 'Winnetou', h: 'Blutsbrüderschaft', h2: 'Prärie', h3: 'Westernfilm' },
    { w: 'Fack ju Göhte', h: 'Schulkomödie', h2: 'Derb', h3: 'Jugendfilm' },
    { w: 'Keinohrhasen', h: 'Liebeskomödie', h2: 'Kinderbuch', h3: 'Kinohit' },
    { w: 'Tatort', h: 'Ermittler', h2: 'Feststehend', h3: 'Krimireihe' },
    { w: 'Lindenstraße', h: 'Dauerläufer', h2: 'Nachbarschaft', h3: 'Vorabendserie' },
    { w: 'Ein Herz und eine Seele', h: 'Streitlustig', h2: 'Ruppig', h3: 'Fernsehklassiker' },
    { w: 'Dinner for One', h: 'Wiederholt', h2: 'Angeheitert', h3: 'Feiertagsabend' },
    { w: 'Stromberg', h: 'Büroalltag', h2: 'Peinlich', h3: 'Fernsehkomödie' },
    { w: 'Türkisch für Anfänger', h: 'Patchworkfamilie', h2: 'Frech', h3: 'Vorabendserie' },
    { w: 'Dark', h: 'Zeitreise', h2: 'Düster', h3: 'Mysteryserie' },
    { w: 'Babylon Berlin', h: 'Zwanziger', h2: 'Ermittlung', h3: 'Krimireihe' },
    { w: 'Das Traumschiff', h: 'Fernreise', h2: 'Kitschig', h3: 'Feiertagsabend' },
    { w: 'Raumschiff Enterprise', h: 'Weltraum', h2: 'Brückenkommando', h3: 'Zukunftsserie' },
    { w: 'Wer wird Millionär', h: 'Quizshow', h2: 'Publikumsjoker', h3: 'Ratesendung' },
  ],
  'Football': [
    { w: 'Bayern München', h: 'Rekordmeister', h2: 'Übermächtig', h3: 'Süddeutschland' },
    { w: 'Borussia Dortmund', h: 'Gelbe Wand', h2: 'Stimmungsvoll', h3: 'Ruhrgebiet' },
    { w: 'Schalke', h: 'Knappen', h2: 'Bergbauerbe', h3: 'Ruhrgebiet' },
    { w: 'Werder Bremen', h: 'Grünweiß', h2: 'Hanseatisch', h3: 'Norddeutschland' },
    { w: 'Hamburger SV', h: 'Dinosaurier', h2: 'Abstiegsdrama', h3: 'Norddeutschland' },
    { w: 'Eintracht Frankfurt', h: 'Europapokalnächte', h2: 'Leidenschaftlich', h3: 'Großstadtklub' },
    { w: 'Borussia Mönchengladbach', h: 'Fohlenelf', h2: 'Siebziger', h3: 'Rheinland' },
    { w: 'VfB Stuttgart', h: 'Brustring', h2: 'Schwäbisch', h3: 'Süddeutschland' },
    ...
    { w: 'FC Köln', h: 'Geißbock', h2: 'Karnevalistisch', h3: 'Rheinland' },
    { w: 'Hertha BSC', h: 'Hauptstadtklub', h2: 'Wechselhaft', h3: 'Stadtrivale' },
    { w: 'Union Berlin', h: 'Kiezverein', h2: 'Bescheiden', h3: 'Stadtrivale' },
    { w: 'St. Pauli', h: 'Totenkopf', h2: 'Alternativ', h3: 'Norddeutschland' },
    { w: 'Nürnberg', h: 'Traditionsreich', h2: 'Achterbahnfahrt', h3: 'Süddeutschland' },
    { w: 'Beckenbauer', h: 'Souverän', h2: 'Elegant', h3: 'Abwehrchef' },
    { w: 'Müller', h: 'Torjäger', h2: 'Instinktsicher', h3: 'Angreifer' },
    { w: 'Klinsmann', h: 'Stürmerlegende', h2: 'Goldblond', h3: 'Angreifer' },
    { w: 'Matthäus', h: 'Antriebsstark', h2: 'Ausdauernd', h3: 'Mittelfeldmotor' },
    { w: 'Kahn', h: 'Torwarttitan', h2: 'Furchteinflößend', h3: 'Torhüter' },
    { w: 'Neuer', h: 'Mitspielend', h2: 'Weitaufgerückt', h3: 'Torhüter' },
    { w: 'Lahm', h: 'Beidfüßig', h2: 'Unauffällig', h3: 'Abwehrchef' },
    { w: 'Schweinsteiger', h: 'Kämpferisch', h2: 'Blutend', h3: 'Mittelfeldmotor' },
    { w: 'Özil', h: 'Spielmacher', h2: 'Zurückhaltend', h3: 'Passgeber' },
    { w: 'Klose', h: 'Bescheiden', h2: 'Abschlussstark', h3: 'Angreifer' },
    { w: 'Ballack', h: 'Kopfballstark', h2: 'Führungsspieler', h3: 'Mittelfeldmotor' },
    { w: 'Rummenigge', h: 'Achtziger', h2: 'Flügelstürmer', h3: 'Vereinslegende' },
    { w: 'Netzer', h: 'Langhaarig', h2: 'Spielgestaltend', h3: 'Passgeber' },
    { w: 'Seeler', h: 'Bodenständig', h2: 'Volksnah', h3: 'Vereinslegende' },
    { w: 'Sammer', h: 'Vorstopper', h2: 'Wuselig', h3: 'Abwehrchef' },
    { w: 'Messi', h: 'Zauberhaft', h2: 'Kleingewachsen', h3: 'Weltstar' },
    { w: 'Ronaldo', h: 'Ehrgeizig', h2: 'Athletisch', h3: 'Weltstar' },
    { w: 'Maradona', h: 'Legendär', h2: 'Umjubelt', h3: 'Altmeister' },
    { w: 'Pelé', h: 'Wegbereitend', h2: 'Ikonisch', h3: 'Altmeister' },
    { w: 'Zidane', h: 'Meisterhaft', h2: 'Gelassen', h3: 'Weltstar' },
    { w: 'Mbappé', h: 'Blitzschnell', h2: 'Blutjung', h3: 'Weltstar' },
    { w: 'Haaland', h: 'Hochgewachsen', h2: 'Maschinenhaft', h3: 'Weltstar' },
    { w: 'Cruyff', h: 'Wendig', h2: 'Vorausdenkend', h3: 'Altmeister' },
    { w: 'Elfmeter', h: 'Punktgenau', h2: 'Nervenprobe', h3: 'Standardsituation' },
    { w: 'Abseits', h: 'Millimeterarbeit', h2: 'Strittig', h3: 'Regelentscheidung' },
    { w: 'Rote Karte', h: 'Platzverweis', h2: 'Endgültig', h3: 'Regelentscheidung' },
    { w: 'Eckball', h: 'Hereingabe', h2: 'Gedränge', h3: 'Standardsituation' },
    { w: 'Freistoß', h: 'Mauerstellung', h2: 'Anlaufweg', h3: 'Standardsituation' },
    { w: 'Tor', h: 'Jubel', h2: 'Erlösend', h3: 'Anzeigetafel' },
    { w: 'Schiedsrichter', h: 'Unparteiisch', h2: 'Angefeindet', h3: 'Regelentscheidung' },
    { w: 'Bundesliga', h: 'Achtzehn Vereine', h2: 'Wöchentlich', h3: 'Wettbewerb' },
    { w: 'Weltmeisterschaft', h: 'Vierjährlich', h2: 'Fiebernd', h3: 'Wettbewerb' },
    { w: 'Pokalfinale', h: 'Endspiel', h2: 'Außenseiterchance', h3: 'Titelkampf' },
    { w: 'Derby', h: 'Nachbarschaftsduell', h2: 'Aufgeheizt', h3: 'Großes Spiel' },
    { w: 'Trikot', h: 'Getauscht', h2: 'Nummeriert', h3: 'Spielkleidung' },
  ],
  'Super Heroes': [
    { w: 'Batman', h: 'Grüblerisch', h2: 'Vermögend', h3: 'Gotham' },
    { w: 'Superman', h: 'Unverwundbar', h2: 'Idealistisch', h3: 'Roter Umhang' },
    { w: 'Spider-Man', h: 'Jugendlich', h2: 'Findig', h3: 'New York' },
    { w: 'Iron Man', h: 'Erfinderisch', h2: 'Überheblich', h3: 'Milliardär' },
    { w: 'Wonder Woman', h: 'Königlich', h2: 'Kriegerisch', h3: 'Antike Welt' },
    { w: 'Black Panther', h: 'Edelmütig', h2: 'Verschlossen', h3: 'Thronfolge' },
    { w: 'Deadpool', h: 'Spöttisch', h2: 'Chaotisch', h3: 'Roter Anzug' },
    { w: 'Hulk', h: 'Wutentbrannt', h2: 'Riesenhaft', h3: 'Heldenteam' },
    { w: 'Thor', h: 'Donnernd', h2: 'Göttlich', h3: 'Asgard' },
    { w: 'Captain America', h: 'Pflichtbewusst', h2: 'Altmodisch', h3: 'Kriegszeit' },
    { w: 'Black Widow', h: 'Spionage', h2: 'Akrobatisch', h3: 'Agentin' },
    { w: 'Doctor Strange', h: 'Mystisch', h2: 'Hochmütig', h3: 'Zauberkraft' },
    { w: 'Ant-Man', h: 'Schrumpfend', h2: 'Witzig', h3: 'Heldenteam' },
    { w: 'Groot', h: 'Wortkarg', h2: 'Hölzern', h3: 'Weltraumcrew' },
    { w: 'Rocket', h: 'Vorlaut', h2: 'Waffenvernarrt', h3: 'Weltraumcrew' },
    { w: 'Star-Lord', h: 'Aufschneiderisch', h2: 'Musikverliebt', h3: 'Weltraumcrew' },
    { w: 'Scarlet Witch', h: 'Machtvoll', h2: 'Trauernd', h3: 'Zauberkraft' },
    { w: 'Loki', h: 'Hinterlistig', h2: 'Wandelbar', h3: 'Asgard' },
    { w: 'Thanos', h: 'Unerbittlich', h2: 'Gewaltig', h3: 'Erzschurke' },
    { w: 'Wolverine', h: 'Aufbrausend', h2: 'Unverwüstlich', h3: 'Mutant' },
    { w: 'Flash', h: 'Rasend', h2: 'Aufgedreht', h3: 'Roter Anzug' },
    { w: 'Aquaman', h: 'Meeresbeherrschend', h2: 'Bärtig', h3: 'Thronfolge' },
    { w: 'Catwoman', h: 'Geschmeidig', h2: 'Diebisch', h3: 'Gotham' },
    { w: 'Joker', h: 'Wahnsinnig', h2: 'Grinsend', h3: 'Gotham' },
    { w: 'Harley Quinn', h: 'Sprunghaft', h2: 'Verspielt', h3: 'Gotham' },
    { w: 'Venom', h: 'Schwarzglänzend', h2: 'Bedrohlich', h3: 'Spinnengegner' },
    { w: 'Green Goblin', h: 'Irrsinnig', h2: 'Zerstörerisch', h3: 'Spinnengegner' },
    { w: 'Daredevil', h: 'Blind', h2: 'Furchtlos', h3: 'New York' },
    { w: 'Blade', h: 'Halbvampirisch', h2: 'Kühl', h3: 'Dämonenblut' },
    { w: 'Hellboy', h: 'Rotäugig', h2: 'Brummig', h3: 'Dämonenblut' },
    { w: 'Doctor Doom', h: 'Herrschsüchtig', h2: 'Größenwahnsinnig', h3: 'Erzschurke' },
    { w: 'Mystique', h: 'Gestaltwandelnd', h2: 'Undurchschaubar', h3: 'Mutant' },
    { w: 'Phantomias', h: 'Doppelleben', h2: 'Erfindungsreich', h3: 'Comicklassiker' },
    { w: 'Perry Rhodan', h: 'Heftromanheld', h2: 'Unsterblich', h3: 'Sternenreise' },
    { w: 'Captain Future', h: 'Zukunftsheld', h2: 'Raumfahrend', h3: 'Sternenreise' },
    { w: 'Son-Goku', h: 'Gutmütig', h2: 'Kampflustig', h3: 'Animeheld' },
    { w: 'Sailor Moon', h: 'Schülerin', h2: 'Verwandlungsformel', h3: 'Animeheld' },
    { w: 'Ruffy', h: 'Gummiartig', h2: 'Unbekümmert', h3: 'Animeheld' },
    { w: 'Naruto', h: 'Aufmüpfig', h2: 'Zielstrebig', h3: 'Animeheld' },
    { w: 'Saber Rider', h: 'Westernhaft', h2: 'Weltraumreitend', h3: 'Achtzigerserie' },
    { w: 'He-Man', h: 'Muskelbepackt', h2: 'Schwertschwingend', h3: 'Achtzigerserie' },
    { w: 'Sigurd', h: 'Ritterlich', h2: 'Unbeugsam', h3: 'Comicklassiker' },
    { w: 'Nick Knatterton', h: 'Kombinierend', h2: 'Kariert', h3: 'Comicklassiker' },
    { w: 'Abrafaxe', h: 'Zeitreisend', h2: 'Dreiergespann', h3: 'Comicklassiker' },
    { w: 'Das Phantom', h: 'Maskiert', h2: 'Dschungelheld', h3: 'Comicklassiker' },
    { w: 'Zorro', h: 'Degenführend', h2: 'Schwarzgekleidet', h3: 'Westernheld' },
    { w: 'Asterix', h: 'Schlagfertig', h2: 'Kleinwüchsig', h3: 'Gallierdorf' },
    { w: 'Obelix', h: 'Hünenhaft', h2: 'Gutgelaunt', h3: 'Gallierdorf' },
    { w: 'Lucky Luke', h: 'Schnellziehend', h2: 'Einzelgängerisch', h3: 'Westernheld' },
    { w: 'Vegeta', h: 'Stolz', h2: 'Rivalisierend', h3: 'Animeheld' },
  ],
};
