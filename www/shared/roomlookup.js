...
const GAMES = [
  { game: 'music', tree: 'rooms',      path: '/dance/', label: 'Dance Game' },
  { game: 'word',  tree: 'rooms-word', path: '/word/',  label: 'Word Game'  },
  { game: 'draw',  tree: 'rooms-draw', path: '/draw/',  label: 'Draw Game'  },
];
